...
export class PatientCptCodeReportListComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (!this.isLogin) {
            ...
            // this.listPagePermission = this._utilityService.checkUserPermission(this.user, 'view_report_ccm_cpt_code');
            this.listPagePermission = this._utilityService.checkUserPermissionViewPermissionObj(this.userPermissions, 'view_report_ccm_cpt_code');
        ...
        if (this.listPagePermission) {
            ...
            this._reportService.getPatientCptReportListCount(this.doctorId, this.cptOptionId, this.startDate, this.endDate, this.searchKeyword).subscribe(
                (res) => {
                    ...
                    this._reportService.getPatientCptReportListPagination(0, length, this.doctorId, this.cptOptionId, this.startDate, this.endDate, this.searchKeyword).subscribe(
                        (res) => {
                            // this.userList = res.json();
                            // this._uiService.hideSpinner();
    ...
    generatePDF() {
        ...
        doc.save('Patient CPT Code Report.pdf');
        this._uiService.hideSpinner();
    }
    ...
    exportMapData() {
        ...
        this._excelService.exportAsExcelFile(this.exportData, "Patient CPT Code Report");
        this._uiService.hideSpinner();
