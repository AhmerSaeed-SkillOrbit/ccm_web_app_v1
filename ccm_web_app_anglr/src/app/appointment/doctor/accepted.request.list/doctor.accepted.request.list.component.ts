...
@Component({
    selector: 'doctor-accepted-request-list',
    moduleId: module.id,
    templateUrl: 'doctor.accepted.request.list.component.html',
    // styleUrls: ['invite.doctor.component.css']
})
export class DoctorAcceptedRequestListComponent implements OnInit {
    files: any;
