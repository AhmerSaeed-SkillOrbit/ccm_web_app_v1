...
@Component({
    selector: 'doctor-pending-request-list',
    moduleId: module.id,
    templateUrl: 'doctor.pending.request.list.component.html',
    // styleUrls: ['invite.doctor.component.css']
})
export class DoctorPendingRequestListComponent implements OnInit {
    files: any;
