...
@Component({
    selector: 'patient-pending-request-list',
    moduleId: module.id,
    templateUrl: 'patient.pending.request.list.component.html',
    // styleUrls: ['invite.doctor.component.css']
})
export class PatientPendingRequestListComponent implements OnInit {
    files: any;
