        ...
        if (this.formRegister.invalid) {
            ...
            this._userService.updateUser(this.newUser).subscribe(
                (res) => {
                    ...
                    let isUser: User = this._utilityService.deepCopy(this.user);

                    isUser.firstName = this.newUser.firstName;
                    isUser.lastName = this.newUser.lastName;
                    isUser.countryPhoneCode = this.newUser.countryPhoneCode;
                    isUser.phoneNumber = this.newUser.phoneNumber;
                    isUser.mobileNumber = this.newUser.mobileNumber;
                    isUser.officeAddress = this.newUser.officeAddress;
                    isUser.residentialAddress = this.newUser.residentialAddress;
