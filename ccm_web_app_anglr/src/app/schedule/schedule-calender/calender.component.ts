...
export class CalenderComponent implements OnInit {
  ...
  constructor(private _doctorScheduleService: DoctorScheduleService, private _router: Router, private _uiService: UIService, ) {
  ...
  ngOnInit() {
    ...
    for (var index = 0; index < this.offDaysremove.length; index++) {
      ...
      this._doctorScheduleService.setOffDays(this.offDaysremove[index].id, this.offDaysremove[index].offDay, false).subscribe(
        ...
        (response) => {
          ...
          if (response.status == 200) {
            ...
            this._doctorScheduleService.callMethodOfSecondComponent();
    ...
    for (var index = 0; index < this.selectedDates.length; index++) {
      ...
      this._doctorScheduleService.setOffDays(0, this.selectedDates[index], true).subscribe(
